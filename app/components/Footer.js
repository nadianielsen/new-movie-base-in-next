...
const Footer = () => {
    ...
    return ( 
        <footer className="bg-gradient-to-t from-black/80 to-transparent lg:bg-black fixed lg:static backdrop-blur-[1px] bottom-0 w-full h-20 lg:h-56 py-2.5 lg:grid lg:grid-rows-3 lg:gap-y-6 lg:place-content-center">
